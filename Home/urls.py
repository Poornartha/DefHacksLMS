...
from .views import course_listed, subjects_listed, subjects_create, user_login, user_logout, teacher_signup, student_signup, parent_signup, confirm_email, check_otp
